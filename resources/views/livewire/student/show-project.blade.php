...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="space-y-8">
            ...
            <!-- Archivos -->
            @livewire('ui.file-uploader', ['project' => $project])

            <!-- Feedback -->
            @livewire('ui.feedback-component', ['project' => $project])
        </div>
    </div>
</div>
@endsection